...
logo= f'''
{G}     .aMMMMP dMP dMP dMMMMMP dMMMMMMMMb  .aMMMb  dMMMMb 
{R}    dMP"    dMP dMP   .dMP" dMP"dMP"dMP dMP"dMP dMP dMP 
{Y}   dMP MMP"dMP dMP  .dMP"  dMP dMP dMP dMMMMMP dMP dMP  
{S}  dMP.dMP dMP.aMP .dMP"   dMP dMP dMP dMP dMP dMP dMP   
{uu}  VMMMP"  VMMMP" dMMMMMP dMP dMP dMP dMP dMP dMP dMP     
\033[1;93m=======================================================
\033[1;97m Owner  : GUZMAN
\033[1;97m GitHub : GUZMAN92 
\033[1;97m Version:\033[1;92m 1.1\033[1;97m
\033[1;97m Status : TRAIL
...
def method():
    ...
    if 'o':      
        ...
        if lp.isnumeric():
            ex = '786786 000786 firstlast first123 last123'
            print(f'{oo("+")}{ex} (ETC)')
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mGZM-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
